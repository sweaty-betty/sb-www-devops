...
$Powershellfiles = (Get-ChildItem -Recurse | Where-Object {$_.Name -like "*.psm1" -or $_.Name -like "*.ps1" -and $_.FullName -notlike "*.Tests.ps1" -and $_.FullName -notlike "*Pester.ps1"}).FullName
