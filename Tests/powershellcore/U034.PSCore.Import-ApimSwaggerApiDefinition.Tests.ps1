...
Describe "Import-ApimSwaggerApiDefinition unit tests" -Tag "DontRun" {
    ...
    BeforeAll {
        ...
        Mock Invoke-RestMethod -MockWith {
            ...
            return '{"swagger":"2.0","info":{"title":"mock API","version":"0.1.2"},"host":"sb-foo-bar-fa.azurewebsites.net","basePath":"/","schemes":["https"]}'
        }
        ...
        $BaseParameters = @{
            ...
            ApiName                 = "bar-api"
            SwaggerSpecificationUrl = "https://sb-foo-bar-fa.azurewebsites.net/swagger/json"
            ApiPath                 = "bar"
        }
    }
    ...
    It "Should import standard api from specification" {
        ...
        Should -Invoke -CommandName Import-AzApiManagementApi -Exactly 1 -Scope It -ParameterFilter { $SpecificationUrl -eq "https://sb-foo-bar-fa.azurewebsites.net/swagger/json" }
    ...
    It "Should import versioned api from specification" {
        ...
        Should -Invoke -CommandName Import-AzApiManagementApi -Exactly 1 -Scope It -ParameterFilter { $SpecificationUrl -eq "https://sb-foo-bar-fa.azurewebsites.net/swagger/json" -and $ApiVersion -eq "v1" }
    ...
    It "Should download and import versioned api from specification" {
        ...
        $DownloadVersionedParameters = @{
            ...
            InstanceName             = "sb-foo-bar-apim"
            ApiName                  = "bar-api"
            SwaggerSpecificationUrl  = "https://sb-foo-bar-v2-fa.azurewebsites.net/swagger/json"
            ApiPath                  = "bar"
            ApiVersionSetId          = "bar-api-versionset"
            ApiVersion               = "v2"
