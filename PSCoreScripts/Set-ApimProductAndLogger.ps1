...
.EXAMPLE
Set-ApimProductAndLogger -ApimResourceGroup sb-foo-shared-rg -InstanceName sb-foo-shared-apim -ApiId barapi -ApiProductId bar-product -ApimLoggerName bar-logger
#>
[CmdletBinding()]
param(
