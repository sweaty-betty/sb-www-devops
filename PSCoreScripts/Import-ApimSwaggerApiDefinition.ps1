...
.EXAMPLE
Import-ApimSwaggerApiDefinition -ApimResourceGroup sb-foo-bar-rg -InstanceName sb-foo-bar-apim -ApiName bar -SwaggerSpecificationUrl "https://sb-foo-bar-fa.azurewebsites.net/api/bar/api-definition" -SwaggerSpecificationFile -OutputFilePath $(System.DefaultWorkingDirectory)/SwaggerFile -Verbose
