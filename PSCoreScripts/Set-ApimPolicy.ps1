...
Set-ApimPolicy -PolicyScope tenant -ApimResourceGroup sb-foo-bar-rg -ApimServiceName sb-foo-bar-apim -PolicyFilePath some-file

#Set product scoped policy
Set-ApimPolicy -PolicyScope product -ApimResourceGroup sb-foo-bar-rg -ApimServiceName sb-foo-bar-apim -PolicyFilePath some-file -ProductId productid

#Set api scoped policy
Set-ApimPolicy -PolicyScope api -ApimResourceGroup sb-foo-bar-rg -ApimServiceName sb-foo-bar-apim -PolicyFilePath some-file -ApiId apiid

#Set operation scoped policy
Set-ApimPolicy -PolicyScope operation -ApimResourceGroup sb-foo-bar-rg -ApimServiceName sb-foo-bar-apim -PolicyFilePath some-file -ApiId apiid -OperationId operationid

#Return a list of all valid product, api and operation IDs available on the given service
Set-ApimPolicy -PolicyScope listavailable -ApimResourceGroup sb-foo-bar-rg -ApimServiceName sb-foo-bar-apim
#>
[CmdletBinding()]
Param(
