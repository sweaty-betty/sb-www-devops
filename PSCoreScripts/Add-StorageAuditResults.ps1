...
An array of environment names.  Assumes that the sb naming convention for storage accounts is followed, ie <service><environment><project>str, eg sbfooprojectbarstr
