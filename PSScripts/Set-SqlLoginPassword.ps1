...
.EXAMPLE
Set-SqlLoginPassword -SQLServerName sb-foo-bar-sql -SQLDatabase sb-foo-bar-db -SQLAdminUsername sa -SQLAdminPassword password1 -SQLLogin connection_user -SQLLoginPassword abc123
