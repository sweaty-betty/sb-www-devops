...
.PARAMETER ApiName
The name of the API, currently limited to Microsoft Graph and any correctly formated sb API (must start "sb-<env>-", where <env> is the name of the environment, eg "dev")
...
param(
    ...
    [ValidatePattern("^(Microsoft Graph|sb-\w+-.+)$")]
    [Parameter(Mandatory=$true)]
    [String]$ApiName,
