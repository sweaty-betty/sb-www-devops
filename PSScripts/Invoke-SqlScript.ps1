...
.EXAMPLE
Set-SqlLoginPassword -SQLServerFqdn sb-foo-bar-sql.database.windows.net -SQLDatabase sb-foo-bar-db -SQLAdminUsername sa -SQLAdminPassword password1 SQLScript C:\Path\To\Script.sql
