...
.EXAMPLE
New-DatabaseFromBlobFile -SQLServerName sb-foo-bar-sql -SQLDatabase sb-foo-bar-db -SQLAdminUsername sa -SQLAdminPassword password1 -StorageUrl https://sbfoobarstr.blob.core.windows.net/backup/db.bacpac -StorageAccountKey letmein==
